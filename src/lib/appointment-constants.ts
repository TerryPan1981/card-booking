...
export const INTENTS = [
  ...
  { key: "sell", label: "賣房", emoji: "🏷️", placeholder: "例:江翠北側的房子想賣、換屋週轉、希望盡快出售" },
  ...
  { key: "other", label: "其他", emoji: "💬", placeholder: "簡單描述你想找阿睿聊的事" },
] as const;
...
export const MEET_TYPES = [
  { key: "office", label: "公司面談", emoji: "🏢", desc: "台灣房屋・華江一路 508 號" },
  // 2026-07-17 新增：分公司（範例）
  { key: "hq", label: "分公司", emoji: "🏛️", desc: "台中市西屯區台灣大道三段 660 號 4F-2（範例大樓）" },
  { key: "studio", label: "台灣房屋工作室", emoji: "🐻", desc: "台中市西屯區烈美街55巷12號" },
  { key: "phone", label: "電話聯繫", emoji: "📞", desc: "阿睿主動來電" },
